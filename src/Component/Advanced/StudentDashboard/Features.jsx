...
const Features = () => {
  // State to control visibility of last 2 cards
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Track performance and user activities in real-time dashboard.",
    ...
    },
    {
      ...
      description: "24/7 dedicated support with priority response for premium users.",
      borderColor: "border-accent2",
      notifications: 1,
      visible: showAdvancedFeatures
    }
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex items-center space-x-3 ml-4">
                    ...
                    {/* View Button */}
                    <button className="flex items-center space-x-1 bg-primary hover:bg-secondary text-white px-3 py-1.5 rounded-lg transition-all duration-200 hover:shadow-md text-sm font-medium">
